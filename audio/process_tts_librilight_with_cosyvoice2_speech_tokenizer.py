            ...
            try:
                with open(transcript_file, "r") as file:
                    for line in file:
                        ...
                        wav_file = wav_file.replace("librilight/split_whisper", "librilight_processed")
                        text = j['refined']
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--transcript_data_dir',
        type=str,
        default='/lp/dataset/audio_data/librilight_processed/jsonl_splits/group_1',
    ...
    parser.add_argument(
        '--output_tar_prefix',
        type=str,
        default='/gpfs/public/mmodal/users/liupeng/webdataset/librilight/librilight',
